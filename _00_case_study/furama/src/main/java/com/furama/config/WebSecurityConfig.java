...
import com.furama.service.login.UserDetailsServiceImpl;
...
//        String password = bCryptPasswordEncoder.encode("123123");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/customer", "/service", "/contract", "/")
        ...
        http.authorizeRequests().and().formLogin()//
                ...
                .and().logout().logoutUrl("/logout").logoutSuccessUrl("/logout-successfully");
