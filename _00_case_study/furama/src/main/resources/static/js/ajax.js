...
function getService(service) {
    return `<td>${service.serviceCode}</td><td>${service.serviceName}</td><td>${service.serviceArea}</td>
            <td>${service.serviceCost}</td><td>${service.serviceMaxPeople}</td><td>${service.serviceStandardRoom}</td>
            <td>${service.descriptionOtherConvenience}</td><td>${service.servicePoolArea}</td><td>${service.serviceNumberOfFloors}</td>
            <td>${service.rentType.rentTypeName}</td><td>${service.serviceType.serviceTypeName}</td>
            <td><a class="editService text-decoration-none"  href="${service.serviceId}">Edit</a></td>
...
$(document).ready(function () {
    $("#serviceTable").on("click", ".editService", function () {
        let a = $(this);
        let id = a.attr("href");
        debugger
        showEditForm(id)
